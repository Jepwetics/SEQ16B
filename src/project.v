 ...
 * over a simple SPI-like port, raise RUN, and it drives 16 output pins
 * according to that program.
 *
 * Grown from the working 8-instruction version: twice the program
 * memory, and a second 8-bit output port on the bidirectional pins.
 *
